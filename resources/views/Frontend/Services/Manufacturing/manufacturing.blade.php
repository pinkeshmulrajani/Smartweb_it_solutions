                        ...
                        <div class="text-center">
                            <div class="title wow fadeInUp" data-wow-delay="0.1s">
                                <div class="pricing-box height-fix small-box p-4 mb-4 bg-white shadow-sm rounded title-center">
                                    <h1 style="color: #3a4172;">Manufacturing Service</h1>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-sm-6">
                                        <div class="pricing-box height-fix small-box p-4 mb-4 bg-white shadow-sm rounded">
                                            <h3 style="color: #3a4172; text-align:center;">Manufacturing Software</h3><hr>

                                            <ul class="list-unstyled">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="pricing-box height-fix small-box p-4 mb-4 bg-white shadow-sm rounded">
                                                            <img src="img/Manufacturing1.png">
                                                    ...
                                                    <div class="pricing-box height-fix small-box p-4 mb-4 bg-white shadow-sm rounded">
                                                        <h5 style="color: #3a4172">
                                                            Marg ERP Manufacturing Software using multi trade Pharmaceutical, Automobile Industry, etc. Software is
                                                            designed to handle all the needs in most efficient, effective & accurate way. MARG Manufacturing Software
                                                            was launched in the market during 2000. Since then MARG is committed to provide the best supporting system
                                                            for the Manufacturing Business upgrading itself from time to time according to the market needs.
                                                        </h5>
                                                        <h5 style="color: #3a4172">
